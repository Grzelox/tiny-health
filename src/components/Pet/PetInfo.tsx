  ...
  return (
    <div className="animate-in">
      ...
      <div className="card-modern rounded-2xl p-8 mb-8 relative overflow-hidden">
        ...
        {!petData.isDead && (
          <div className="pointer-events-none absolute top-0 right-0 w-48 h-48 bg-linear-to-bl from-primary-400/20 to-transparent rounded-full blur-3xl" />
        )}
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Weight */}
            <div
              className="glass-effect bg-secondary-50/80 backdrop-blur-sm p-6 rounded-xl border border-secondary-200/50 hover:shadow-modern-lg hover:border-secondary-300/70 transition-all duration-300 group relative hover:bg-secondary-100/60 cursor-pointer"
